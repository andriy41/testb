...
import { MarketSignal, TrendType } from '../types/market';

export function analyzeMarket(marketSignal: MarketSignal) {
  let trend: TrendType = 'NEUTRAL';
  const signals: string[] = [];
  let confidence = marketSignal.mlAnalysis.confidence;
